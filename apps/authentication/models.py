...
class UsersManager(BaseUserManager):
    def create_user(self, ci, password=None, **kwargs):
        if not ci:
            raise ValueError('Los usuarios deben tener un ci válido.')
...
class Users(AbstractBaseUser, PermissionsMixin):
    ...
    is_director_ipasme = models.BooleanField(_('Director'), default=False)
    is_secretaria_ipasme = models.BooleanField(_('Secretaria De Danza'),  blank=True,default=False)
    is_usuario_ipasme = models.BooleanField(_('Secretaria De Teatro'),  blank=True,default=False)
